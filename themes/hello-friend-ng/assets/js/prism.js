...
(function () {
    ...
    Prism.plugins.lineHighlight = {
        ...
        highlightLines: function highlightLines(pre, lines, classes) {
            ...
            var annotations = (pre.getAttribute('annotations') || '').split(',')
            ...
            ranges.forEach(function (currentRange, rangeIndex) {
                ...
                if (hasLineNumbers && Prism.plugins.lineNumbers) {
                    ...
                    mutateActions.push(function () {
                        line.setAttribute('data-start', annotations.at(rangeIndex) || rangeIndex + 1);

...
private val DSL_KEYWORD_REGEX = """\b(MONDAY|TUESDAY|projects|firstLibrary|compileKotlin|explicitApiMode|Strict|buildscript|allprojects|subprojects|dependencies|tasks)\b""".toRegex()
